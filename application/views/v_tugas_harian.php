                ...
                <div class="card-content">
                    ...
                    <form method="#" action="#">
                        ...
                        <div class="form-group label-floating">
                            ...
                            <select class="selectpicker" data-style="select-with-transition" multiple title="Pilih Kategori Tugas">
                                <option disabled>Kategori Tugas</option>
                                <option value="2">Tugas Pokok </option>
                        ...
                        <div class="data form-group label-floating">
